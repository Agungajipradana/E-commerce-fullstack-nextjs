...
const NikeMenView = ({ nikeMen }: { nikeMen: ProductsProps[] }) => {
  return (
    <>
      <div className={style.nikeMen__title}>
        <Image src={NikeImage} alt="Nike Logo" width={300} height={300} className={style.nikeMen__title__image} priority />
        <h1 className={style.nikeMen__title__h1}>Nike For Men</h1>
      </div>
